    ...
    function rollContainer() {
        ...
        const contentsIndex = Math.floor(Math.random() * contents.length)
        blurt({
            title: 'Contents',
            text: contents[contentsIndex],
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
    ...
    function rollBooks() {
        ...
        const booksIndex = Math.floor(Math.random() * books.length)
        blurt({
            title: 'Books',
            text: books[booksIndex],
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
