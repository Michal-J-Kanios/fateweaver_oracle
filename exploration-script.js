    ...
    function chamberContents() {
        const ccontents = [
           ...
           "Dungeon hazard with incidental treasure",
           "Dungeon hazard with incidental treasure",
           "Obstacle (roll on 'Obstacles' table if need be)",
           "Obstacle (roll on 'Obstacles' table if need be)",
           "Obstacle (roll on 'Obstacles' table if need be)",
           "Obstacle (roll on 'Obstacles' table if need be)",
           "Obstacle (roll on 'Obstacles' table if need be)",
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table)",
           ...
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table)",
           "Trap (roll on 'Random Traps' table) protecting treasure",
           "Trap (roll on 'Random Traps' table) protecting treasure",
           "Trap (roll on 'Random Traps' table) protecting treasure",
           "Trick (roll on 'Trick Objects')",
           "Trick (roll on 'Trick Objects')",
           "Trick (roll on 'Trick Objects')",
           "Trick (roll on 'Trick Objects')",
           "Empty room",
        ...
        const ccontentsIndex = Math.floor(Math.random() * ccontents.length)
        blurt({
            title: 'Chamber Contents',
            text: ccontents[ccontentsIndex],
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
    ...
    function rollTrickObject() {
        const trickObject = [
            ...
            "Plant or tree",
            "Pool of water",
            "Rune engraved on wall or floor",
            "Skull",
            ...
            "Suit of armor",
            "Tapestry or rug",
            "Target dummy or mannequin"
        ]
        const trickEffect = [
            "ages the first person to touch the object.",
            "ages the first person to touch the object.",
            "ages the first person to touch the object.",
            "becomes animate, or animates other objects nearby.",
            "becomes animate, or animates other objects nearby.",
            "becomes animate, or animates other objects nearby.",
            "asks three skill-testing questions (if all three are answered correctly, a reward appears).",
            "asks three skill-testing questions (if all three are answered correctly, a reward appears).",
            "asks three skill-testing questions (if all three are answered correctly, a reward appears).",
            "asks three skill-testing questions (if all three are answered correctly, a reward appears).",
            ...
            "bestows resistance or vulnerability.",
            "bestows resistance or vulnerability.",
            "changes a character's alignment, personality, size, appearance, or sex when touched.",
            "changes a character's alignment, personality, size, appearance, or sex when touched.",
            "changes a character's alignment, personality, size, appearance, or sex when touched.",
            "changes one substance to another, such as gold to lead or metal to brittle crystal.",
            "changes one substance to another, such as gold to lead or metal to brittle crystal.",
            "changes one substance to another, such as gold to lead or metal to brittle crystal.",
            ...
            "locks or unlocks exits.",
            "locks or unlocks exits.",
            "offers a game of chance, with the promise of a material reward or valuable information.",
            "offers a game of chance, with the promise of a material reward or valuable information.",
            "offers a game of chance, with the promise of a material reward or valuable information.",
            "helps or harms certain types of creatures.",
            "helps or harms certain types of creatures.",
            "helps or harms certain types of creatures.",
            "casts polymorph on the characters for 1 hour.",
            "casts polymorph on the characters for 1 hour.",
            "casts polymorph on the characters for 1 hour.",
            "presents a puzzle or a riddle.",
            "presents a puzzle or a riddle.",
            "presents a puzzle or a riddle.",
            "prevents movement.",
            "prevents movement.",
            "prevents movement.",
            "releases coins, false coins, gems, false gems, a magic item, or a map.",
            "releases coins, false coins, gems, false gems, a magic item, or a map.",
            "releases coins, false coins, gems, false gems, a magic item, or a map.",
            ...
            "wails loudly when touched.",
            "wails loudly when touched.",
            "talks in normal speech.",
            "talks in rhymes or poetry.",
            "talks gibberish or nonsense.",
        ...
        const trickObjectIndex = Math.floor(Math.random() * trickObject.length)
        const trickEffectIndex = Math.floor(Math.random() * trickEffect.length)
        blurt({
            title: 'Trick Object',
            text: `${trickObject[trickObjectIndex]} that ${trickEffect[trickEffectIndex]}`,
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
    ...
    function chamberPurpose(){
        ...
        if(selectedType == "Generic"){
            ...
            const chamber = [
                ...
                "Shrine dedicated to a deity or other entity",
                "Storage for food, as well as tools used by the maze's guardians to keep the complex in working order",
                "Storage for food, as well as tools used by the maze's guardians to keep the complex in working order",
                "Trap to kill those sent into the maze",
                "Trap to confound those sent into the maze",
                "Well that provides drinking water",
                "Well that provides drinking water (50% chance of being poisoned)",
                "Workshops where doors, torch sconces, and other furnishings are repaired and maintained"
            ]
            const chamberIndex = Math.floor(Math.random() * chamber.length)
            blurt({
                title: 'Chamber Purpose',
            ...
            const chamber = [
                ...
                "Chapel dedicated to deities that watch over the dead and protect their resting places",
                "Chapel dedicated to deities that watch over the dead and protect their resting places",
                ...
                "Guardroom, usually guarded by undead, constructs, or other creatures that don't need to eat or sleep",
                "Guardroom, usually guarded by undead, constructs, or other creatures that don't need to eat or sleep",
                "Robing room for priests to prepare for burial rituals",
                "Storage, stocked with tools for maintaining the tomb and preparing the dead for burial",
                "Storage, stocked with tools for maintaining the tomb and preparing the dead for burial",
            ...
            const chamber = [
                "Armory stocked wih weapons and armor",
            ...
            const chamber = [
                "Antechamber where visitors seeking access to the stronghold wait",
                "Antechamber where visitors seeking access to the stronghold wait",
                "Armory holding high-quality gear, including light siege weapons such as ballistas",
                "Armory holding high-quality gear, including light siege weapons such as ballistas",
                "Armory holding high-quality gear, including light siege weapons such as ballistas",
                ...
                "Bedroom for use by the stronhold's master or important guests",
                "Chapel dedicated to a deity associated with the stronghold's master",
                "Cistern providing drinking water",
                "Cistern providing drinking water",
                "Cistern providing drinking water",
                "Dining room for intimate gatherings or informal meals",
                "Dining room for intimate gatherings or informal meals",
                "Dining room for intimate gatherings or informal meals",
                "Dining room for intimate gatherings or informal meals",
                "Dressing room featuring a number of wardrobes",
                "Gallery for the display of expensive works of art and trophies",
                "Gallery for the display of expensive works of art and trophies",
                ...
                "Kennel where monsters or trained animals that protect the stronghold are kept",
                "Kennel where monsters or trained animals that protect the stronghold are kept",
                "Kitchen designed to prepare exotic foods for large numbers of guests",
                "Kitchen designed to prepare exotic foods for large numbers of guests",
                "Kitchen designed to prepare exotic foods for large numbers of guests",
                "Kitchen designed to prepare exotic foods for large numbers of guests",
                "Kitchen designed to prepare exotic foods for large numbers of guests",
                ...
                "Storage for mundane goods and supplies",
                "Storage for mundane goods and supplies",
                "Strong room or vault for protecting important treasures (75% chance of being hidden behind a secret door)",
                "Study, including a writing desk and a book on the history of the stronghold",
                "Study, including a writing desk and a journal",
                "Study, including a writing desk",
                "Arcane library with various magic scrolls",
                "Study, including a writing desk and amaterur magic scrolls",
                "Study, including a writing desk",
                "Throne room, elaborately decorated",
                "Waiting room where lesser guests are held before receiving an audience",
                "Waiting room where lesser guests are held before receiving an audience",
                "Latrine or bath",
                "Latrine or bath",
                "Crypt belonging to the stronghold's master or someone else of importance",
                "Crypt belonging to the stronghold's master or someone else of importance"
            ]
            const chamberIndex = Math.floor(Math.random() * chamber.length)
            blurt({
            ...
            const chamber = [
                ...
                "Armory containing mundane and magic gear used by the treasure vault's guards",
                "Barracks for guards",
                "Barracks for guards",
                ...
                "Guardroom to defend against intruders",
                "Guardroom to defend against intruders",
                "Kennel for trained beasts used to guard the treasure vault",
                "Kitchen for feeding guards",
                "Watch room that allows guards to observe those who approach the dungeon",
                "Prison for holding captured intruders",
                "Strong room or vault, for guarding the treasure hidden in the dungeon, accessible only by locked or secret door",
                "Strong room or vault, for guarding the treasure hidden in the dungeon, accessible only by locked or secret door",
                "Torture chamber for extracting information from captured intruders",
                "Trap or other trick designed to kill or capture creatures that enter the dungeon",
                "Trap or other trick designed to kill or capture creatures that enter the dungeon",
                "Trap or other trick designed to kill or capture creatures that enter the dungeon"
            ]
            const chamberIndex = Math.floor(Math.random() * chamber.length)
            ...
            const chamber = [
                "Armory filled with weapons and armor, battle banners, and pennants",
                "Audience chamber where priests of the temple receive commoners and low-ranking visitors",
                "Audience chamber where priests of the temple receive commoners and low-ranking visitors",
                "Armory filled with weapons and armor, battle banners, and pennants",
                "Armory filled with weapons and armor, battle banners, and pennants",
                "Banquet room used for celebrations and holy days",
                "Banquet room used for celebrations and holy days",
                "Barracks for the temple's military arm or its hired guards",
                "Barracks for the temple's military arm or its hired guards",
                "Barracks for the temple's military arm or its hired guards",
                ...
                "Central temple built to accommodate rituals",
                "Central temple built to accommodate rituals",
                "Chapel dedicated to a lesser deity associated with the temple's major deity",
                "Chapel dedicated to a lesser deity associated with the temple's major deity",
                "Chapel dedicated to a lesser deity associated with the temple's major deity",
                "Chapel dedicated to a lesser deity associated with the temple's major deity",
                "Classroom used to train initiates and priests",
                "Classroom used to train initiates and priests",
                "Conjuring room, specially sanctified and used to summon extraplanar creatures",
                "Conjuring room, specially sanctified and used to summon extraplanar creatures",
                "Conjuring room, specially sanctified and used to summon extraplanar creatures",
                "Crypt for a high priest or similar figure, hidden and heavily guarded byy creatures and traps",
                "Crypt for a high priest or similar figure, hidden and heavily guarded byy creatures and traps",
                "Crypt for a high priest or similar figure, hidden and heavily guarded byy creatures and traps",
                "Crypt for a high priest or similar figure, hidden and heavily guarded byy creatures and traps",
                "Crypt for a high priest or similar figure, hidden and heavily guarded byy creatures and traps",
                ...
                "Dining room (large) for the temple's servants and lesser priests",
                "Dining room (large) for the temple's servants and lesser priests",
                "Divination room, inscribed with runes and stocked with soothsaying implements",
                "Divination room, inscribed with runes and stocked with soothsaying implements",
                "Divination room, inscribed with runes and stocked with soothsaying implements",
                ...
                "Library, well stocked with religious treatises",
                "Library, well stocked with religious treatises",
                "Library, well stocked with divination spell scrolls",
                "Library, well stocked with abjuration spell scrolls",
                "Library, well stocked with necromancy spell scrolls",
                "Prison for captured enemies",
                "Prison for captured enemies",
                "Prison for captured enemies",
                "Robing room containing ceremonial outfits and items",
                "Robing room containing ceremonial outfits and items",
                "Robing room containing ceremonial outfits and items",
                "Robing room containing ceremonial outfits and items",
                "Robing room containing ceremonial outfits and items",
                ...
                "Torture chamber, used in inquisitions",
                "Torture chamber",
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                ...
                "Trophy room where art celebrating key figures and events from mythology is displayed",
                "Latrine or bath",
                "Well for drinking water, defendable in the case of attack or siege",
                "Well for drinking water, defendable in the case of attack or siege",
                "Well for drinking water, defendable in the case of attack or siege",
                "Well for drinking water, defendable in the case of attack or siege",
                "Workshop for repairing or creating weapons, religious items, and tools",
                "Workshop for repairing or creating weapons, religious items, and tools",
                "Workshop for repairing or creating weapons, religious items, and tools",
                "Workshop for repairing or creating weapons, religious items, and tools",
                "Workshop for repairing or creating weapons, religious items, and tools",
            ...
            const chamber = [
                ...
                "Barracks used by the portal's guards",
                "Barracks used by the portal's guards",
                "Bedroom for use by the high-ranking members of the order that guard the portal",
                "Bedroom for use by the high-ranking members of the order that guard the portal",
                "Bedroom for use by the high-ranking members of the order that guard the portal",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Chapel dedicated to a deity or deities related to the portal and its defenders",
                "Cistern providing fresh water",
                "Cistern providing decent water",
                "Well providing fresh water",
                "Well providing dirty water",
                ...
                "Dining room",
                "Dining room",
                "Divination room used to investigate the portal and events tied to it",
                "Divination room used to investigate the portal and events tied to it",
                "Divination room used to investigate the portal and events tied to it",
                ...
                "Dormitory for visitors and guards",
                "Entry room or vestibule",
                "Gallery for displaying trophies and objects related to the portal and those that guard it",
                "Gallery for displaying trophies and objects related to the portal and those that guard it",
                ...
                "Laboratory for conducting experiments relating to the portal and creatures that emerge from it",
                "Laboratory for conducting experiments relating to the portal and creatures that emerge from it",
                "Library holding books about the portal's history or otherwise thematically connected literature",
                "Library holding books about the portal's history or otherwise thematically connected literature",
                "Library holding books about the portal's history or otherwise thematically connected literature",
                "Library holding books about the portal's history or otherwise thematically connected literature",
                "Pen or prison for holding captives",
                "Pen or prison for holding captives",
                "Pen or prison for holding captives",
                "Pen or prison for holding creatures that come out of the portal",
                "Pen or prison for holding creatures that come out of the portal",
                "Pen or prison for holding creatures that come out of the portal",
                "Planar junction where the gate to another plane once stood (50% chance of being active)",
                "Planar junction where the gate to another plane once stood (50% chance of being active)",
                "Storage",
                "Storage",
                "Storage",
                "Vault for guarding valuable treasures connected to the portal or funds used to pay the planar's gate guardians",
                "Study",
                "Study",
    ...
    function rollDressing() {
        selectedDressing = document.getElementById("dressingType").value;
        if(selectedDressing == "Noise"){
            const noises = [
                "Bang or slam",
                "Bang or slam",
                "Bang or slam",
            ...
            const noisesIndex = Math.floor(Math.random() * noises.length)
            blurt({
                title: 'Noise',
                text: noises[noisesIndex],
                type: 'info',
                okButtonText: 'Click anywhere to exit',
                escapable: true
            });
        }
        if(selectedDressing == "Air"){
            const air = [
                "Clear and damp",
                "Clear and damp",
                "Clear and damp",
            ...
            const airIndex = Math.floor(Math.random() * air.length)
            blurt({
                title: 'Air',
                text: air[airIndex],
                type: 'info',
        ...
        if(selectedDressing == "Odor"){
            ...
            const odorsIndex = Math.floor(Math.random() * odors.length)
            blurt({
                title: 'Odor',
                text: odors[odorsIndex],
                type: 'info',
                okButtonText: 'Click anywhere to exit',
                escapable: true
            });
    ...
    function rollGeneralFeatures() {
        ...
        const generalFeaturesIndex = Math.floor(Math.random() * generalFeatures.length)
        blurt({
            title: 'General Features',
            text: generalFeatures[generalFeaturesIndex],
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
    ...
    function rollFurniture() {
        ...
        const furnitureIndex = Math.floor(Math.random() * furniture.length)
        blurt({
            title: 'Furniture',
            text: furniture[furnitureIndex],
            type: 'info',
            okButtonText: 'Click anywhere to exit',
            escapable: true
        });
