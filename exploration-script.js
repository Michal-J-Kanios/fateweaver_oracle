    ...
    function rollEncounter() {
        ...
        if(selectedBiome == "Forest"){
            ...
            const hillEncounters = [
                ...
                "1d4-1 Hill Giants are running away from an ancient red dragon, having presumably stolen something from his horde. If you roll 0 on the amount of hill giants, there were 3, but they're all dead by the time you got to the scene.",
